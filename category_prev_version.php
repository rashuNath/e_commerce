                ...
                <div class="leftbar p-r-20 p-r-0-sm">
                    ...
                    <ul class="p-b-54">
                        ...
                        foreach ($categories as $category){
                            ...
                            ?>
                            <li class="p-t-4">
                                <a href="category.php?categoryId=<?php echo $category->item_category_id ?>&categoryName=<?php echo $category->name;?>&catItem=item_category_id" class="s-text13">
                                ...
                                if($subCategories != false){
                                    ...
                                    <ul class="padding-left-20">
                                        ...
                                        foreach ($subCategories as $subCategory){
                                            ...
                                            ?>
                                            <li class="p-t-4">
                                                <a href="sub_category.php?subCategoryId=<?php echo $subCategory->item_subcategory_id;?>&subCategoryName=<?php echo $subCategory->name; ?>&cateItem=item_subcategory_id" class="s-text17"><?php echo $subCategory->name;?></a>

                                                <?php if($productCategories): ?>
                                                    <ul class="padding-left-20">
                                                        <?php foreach ($productCategories as $productCategory): ?>
                                                            <li class="p-t-4">
                                                                <a href="category.php?categoryId=<?php echo $productCategory->product_category_id ?>&categoryName=<?php echo $productCategory->name;?>&catItem=product_category_id" class="s-text13">
